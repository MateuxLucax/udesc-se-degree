...
public class AtaqueArqueiroVisitor implements RTSVisitor {

    private final int forcaAtaque;

    public AtaqueArqueiroVisitor(int forcaAtaque) {
    ...
    public void visitArqueiro(Arqueiro arqueiro) {
        arqueiro.setPontoVida(arqueiro.getPontoVida() - forcaAtaque);
    }
