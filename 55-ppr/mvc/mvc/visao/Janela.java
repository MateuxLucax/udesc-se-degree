...
public class Janela extends JFrame implements Observador {
	...
	private final LoteriasUC loterias;
	...
	private final JButton[] bSortear = new JButton[6];
	private final JLabel[] lSortear = new JLabel[6];
	...
	private void initComponents() {
		...
		jbNovo.addActionListener(arg0 -> loterias.iniciarSorteio());
		...
		ActionListener sortear = e -> loterias.sortear();
		for (int i=0; i<6; i++) {
		...
		jbFim.addActionListener(e -> loterias.finalizar());
	...
	public void numSorteado(int idxNumero, int num) {
		...
		lSortear[idxNumero].setText(String.valueOf(num));
