...
public class TelaMarcarConsulta extends javax.swing.JFrame {
    ...
    public void popularMedicos(List<Doctor> medicos){
        for (Doctor m: medicos)
            cbMedico.addItem(m);
    }
    
    public Doctor getMedico(){
        Doctor medico = (Doctor) cbMedico.getSelectedItem();
        return medico;
    }
    ...
    private javax.swing.JComboBox<Doctor> cbMedico;
